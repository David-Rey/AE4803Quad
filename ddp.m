...
[states, controls, last_costs] = fwd_pass(ic, controller, dyn, costfn, term_costfn, alphas(1), xf);
...
for i = 1:iters
    ...
    for j = 1:line_search_iters
        % line search logic
        [states, controls, new_costs] = fwd_pass(ic, controller, dyn, costfn, term_costfn, alphas(j+1), xf);
